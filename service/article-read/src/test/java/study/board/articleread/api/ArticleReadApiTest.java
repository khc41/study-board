...
import study.board.articleread.service.response.ArticleReadPageResponse;
...
public class ArticleReadApiTest {
    ...
    void readAllTest() {
        ...
        System.out.println("response2.getArticleCount() = " + response1.getArticleCount());
    ...
    void readAllInfiniteScrollTest() {
        List<ArticleReadResponse> response1 = articleReadRestClient.get()
                .uri("/v1/articles/infinite-scroll?boardId=%s&pageSize=%s&lastArticleId=%s".formatted(1L, 5L, 189989815997636608L))
                .retrieve()
