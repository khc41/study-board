package study.board.hotarticle.repository;
...
class HotArticleListRepositoryTest {
    ...
    void addTest() throws InterruptedException {
        // given
        LocalDateTime time = LocalDateTime.of(2025, 5, 15, 0, 0);
        long limit = 3;
        ...
        // then
        List<Long> articleIds = hotArticleListRepository.readAll("20250515");
        ...
        assertThat(hotArticleListRepository.readAll("20250515")).isEmpty();
    }
}