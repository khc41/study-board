package study.board.hotarticle.service;
...
import study.board.hotarticle.service.eventhandler.EventHandler;
...
class HotArticleScoreUpdaterTest {
    ...
    void updateIfArticleNotCreatedTodayTest() {
        ...
        LocalDateTime createdTime = LocalDateTime.now().minusDays(1L);
